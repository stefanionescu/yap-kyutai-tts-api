...
def main() -> None:
    ...
    ap.add_argument("--voice", default=os.environ.get("TTS_VOICE", "ears/p058/freeform_speech_01.wav.1e68beda@240.safetensors"), help="Voice path")
