...
async def _tts_one(
    ...
    *,
    ...
    # Minimal WS options: headers only
...
DEFAULT_TEXT = "Wow Danny, you're so hot and handsome! Can't wait for the app to be done so we can talk. See you there sweetie!"
...
def main() -> None:
    ...
    ap.add_argument("--voice", type=str, default=os.environ.get("TTS_VOICE", "ears/p058/freeform_speech_01.wav.1e68beda@240.safetensors"), help="Reference voice path on the server filesystem")
